...
class TributarioMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->view('mail.mail')
            ->subject('Código de Verificación Certificado Tributario')
            ->with([
                'header'    => 'IDRD',
                'title'     => 'Código de Verificación',
                'content'   =>  "¡Hola {$full_name}! para descargar tu Certificado Tributario, usa el siguiente código de verificación.",
