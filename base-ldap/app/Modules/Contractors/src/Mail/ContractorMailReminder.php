...
class ContractorMailReminder extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->view('mail.mail')
            ->subject('Recordatorio: Actualización de Datos Portal Contratista')
            ->with([
                'header'    => 'IDRD',
                'title'     => 'Registro Portal Contratista',
                'content'   =>  "¡{$name}! hemos registrado sus datos satisfactoriamente, para continuar con el proceso de afiliación a la ARL, es indispensable que ingrese sus datos personales en el siguiente enlace.",
                'details'   =>  "
