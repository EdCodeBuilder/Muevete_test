...
class FilesExport implements FromQuery, WithMapping, WithHeadings, WithColumnFormatting, WithEvents, WithTitle
{
    /**
     * @var Request
     */
    ...
    public function map($row): array
    {
        return [
            ...
            'C'    =>  isset( $row->file_type->name ) ? (string) $row->file_type->name : null,
            'D'    =>  isset( $row->file ) ? (string) $row->file : null,
            'E'    =>  isset( $row->status->name ) ? (string) $row->status->name : null,
