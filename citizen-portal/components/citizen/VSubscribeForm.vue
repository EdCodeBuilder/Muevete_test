  ...
  <validation-observer ref="form" v-slot="{ handleSubmit }">
    <v-form @submit.prevent="handleSubmit(onSubmit)">
      <v-row>
        <v-col cols="12" sm="12" md="12">
          ...
          >
            <v-select
              ...
              name="status_id"
              :loading="loading"
              :readonly="loading || statusId === subscribed"
              :disabled="statusId === subscribed"
        ...
        <v-col v-if="statusId !== subscribed" cols="12" sm="12" md="12">
          <validation-provider
            v-slot="{ errors }"
...
export default {
  ...
  methods: {
    onSubmit() {
      ...
      this.form.setFormInstance(this.$refs.form)
      this.form
        .unsubscribe(this.scheduleId, this.profileId)
        .then((response) => {
          this.$snackbar({
